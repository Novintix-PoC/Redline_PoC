...
st.markdown("""
    <style>
        ...
        [data-testid=stHeader] {
            background: linear-gradient( #0e4166 10%, #000000 100%);
        }
...
st.write(f"Output will be saved to a temporary folder")
...
# Display completion message and provide download links
